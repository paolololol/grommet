...
function (_Component6) {
  ...
  function IndeterminateCheckBox() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this8)), "onCheckAll", function (event) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this8)), "onCheck", function (event, value) {
