  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          as = _this$props.as,
          rest = _objectWithoutProperties(_this$props, ["a11yTitle", "color", "forwardRef", "children", "disabled", "icon", "fill", "focus", "href", "label", "onClick", "plain", "primary", "reverse", "theme", "type", "as"]);
