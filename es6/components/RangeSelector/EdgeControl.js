...
function (_Component) {
  ...
  function EdgeControl() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(EdgeControl)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(EdgeControl, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["color", "direction", "edge", "forwardRef", "onDecrease", "onIncrease", "theme"]);
