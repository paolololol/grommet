...
function (_Component) {
  ...
  function AccordionPanel() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AccordionPanel)).call.apply(_getPrototypeOf2, [this].concat(_args)));
  ...
  _createClass(AccordionPanel, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props3, ["children", "header", "label", "theme", "onMouseOut", "onMouseOver", "onFocus", "onBlur"]);
