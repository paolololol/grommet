...
function (_Component) {
  ...
  function ProgressiveDrop() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "boxRef", createRef());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "innerBoxRef", createRef());
