...
function (_Component) {
  ...
  function Drop() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Drop)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Drop, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["target"]);
