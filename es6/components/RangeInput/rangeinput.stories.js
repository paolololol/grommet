...
function (_Component) {
  ...
  function SimpleRangeInput() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SimpleRangeInput)).call.apply(_getPrototypeOf2, [this].concat(args)));
