...
function (_Component) {
  ...
  function RoutedButton() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(RoutedButton)).call.apply(_getPrototypeOf2, [this].concat(_args)));
  ...
  _createClass(RoutedButton, [{
    ...
    value: function render() {
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props2, ["href", "path", "method", "onClick"]);
