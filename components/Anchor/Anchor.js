...
function (_Component) {
  ...
  function Anchor(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Anchor).call(this, props));
  ...
  _createClass(Anchor, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["a11yTitle", "children", "color", "disabled", "forwardRef", "href", "icon", "focus", "label", "onClick", "reverse", "theme"]);
