...
var COMMANDS = {
  curved: function curved(fromPoint, toPoint, offset, anchor) {
    ...
    var cmds = "M ".concat(fromPoint[0] + offset, ",").concat(fromPoint[1] + offset, " ");

    if (anchor === 'horizontal') {
      cmds += "Q ".concat(midPoint[0] + offset, ",").concat(fromPoint[1] + offset, " ") + "".concat(midPoint[0] + offset, ",").concat(midPoint[1] + offset, " ");
    } else {
      cmds += "Q ".concat(fromPoint[0] + offset, ",").concat(midPoint[1] + offset, " ") + "".concat(midPoint[0] + offset, ",").concat(midPoint[1] + offset, " ");
    }

    cmds += "T ".concat(toPoint[0] + offset, ",").concat(toPoint[1] + offset);
    return cmds;
  },
  direct: function direct(fromPoint, toPoint, offset) {
    return "M ".concat(fromPoint[0] + offset, ",").concat(fromPoint[1] + offset, " ") + "L ".concat(toPoint[0] + offset, ",").concat(toPoint[1] + offset);
  },
  rectilinear: function rectilinear(fromPoint, toPoint, offset, anchor) {
    ...
    if (anchor === 'horizontal') {
      cmds += "L ".concat(midPoint[0] + offset, ",").concat(fromPoint[1] + offset, " ") + "L ".concat(midPoint[0] + offset, ",").concat(toPoint[1] + offset, " ");
    } else {
      cmds += "L ".concat(fromPoint[0] + offset, ",").concat(midPoint[1] + offset, " ") + "L ".concat(toPoint[0] + offset, ",").concat(midPoint[1] + offset, " ");
    }

    cmds += "L ".concat(toPoint[0] + offset, ",").concat(toPoint[1] + offset);
    return cmds;
  }
};
...
function (_Component) {
  ...
  function Diagram() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Diagram)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(Diagram, [{
    ...
    key: "placeConnections",
    value: function placeConnections() {
      ...
      var connectionPoints = connections.map(function (_ref) {
        ...
        if (!fromElement) {
          console.warn("Diagram cannot find ".concat(fromTarget));
        }

        if (!toElement) {
          console.warn("Diagram cannot find ".concat(toTarget));
        }
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["connections", "theme"]);
      ...
      if (connectionPoints) {
        paths = connections.map(function (_ref2, index) {
          ...
          var cleanedRest = _objectSpread({}, connectionRest);
