...
function (_Component) {
  ...
  function LazyDrop() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "topLeftTargetRef", (0, _react.createRef)());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "topRightTargetRef", (0, _react.createRef)());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "bottomLeftTargetRef", (0, _react.createRef)());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "bottomRightTargetRef", (0, _react.createRef)());
