...
function (_Component) {
  ...
  function ProgressiveDrop() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "boxRef", (0, _react.createRef)());

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "innerBoxRef", (0, _react.createRef)());
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onCloseDrop", function () {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onOpenDrop", function () {
      return _this.setState({
        openDrop: true,
        openInnerDrop: false
      });
