...
function (_Component) {
  ...
  function FormFieldTextInput() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(FormFieldTextInput)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(FormFieldTextInput, [{
    key: "render",
...
function (_Component2) {
  ...
  function FormFieldSelect() {
    ...
    _this2 = _possibleConstructorReturn(this, (_getPrototypeOf3 = _getPrototypeOf(FormFieldSelect)).call.apply(_getPrototypeOf3, [this].concat(args)));
