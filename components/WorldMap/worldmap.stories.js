...
function (_Component) {
  ...
  function SimpleWorldMap() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SimpleWorldMap)).call.apply(_getPrototypeOf2, [this].concat(args)));
